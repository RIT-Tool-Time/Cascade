...
namespace mtManipulation
{
    ...
    class DrawingObject
    {
        ...
        public void Paint(Graphics graphics)
        {
            ...
            using (SolidBrush brush = new SolidBrush(Color.FromArgb(0,0,210)))
            {
        ...
        internal double RangeFromCenter(Point location)
        {
            Size size = new Size(location - new Size(_middlePosition));
            return Math.Sqrt(size.Height * size.Height + size.Width * size.Width);
        }
    }
}